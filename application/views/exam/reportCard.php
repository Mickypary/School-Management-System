...
if (count($student_array)) {
	...
	<div class="mark-container">
		<table border="3" style="margin-top: 20px; height: 100px;">
			<tbody>
				<tr>
		...
		<table class="table table-bordered" style="margin-top: 20px;" border="2">
			<tbody>
				<tr>
					<th>Name</td>
		...
		<table class="table table-condensed table-bordered mt-lg" border="1">
			<thead>
				<tr>
					<th>Subjects</th>
				<?php 
	...
	<?php } ?>
		<table style="width:100%; outline:none; margin-top: 35px;" border="2">
			<tbody>
				<tr>
